    ...
    <div class="header-content">
        ...
        <nav class="main-nav" role="navigation" aria-label="Main Navigation">
            ...
            <ul id="nav-menu" class="nav-list">
                ...
                <li><a href="customers?action=list" class="nav-link active">Customers</a></li>
        ...
        <div class="search-form-container" style="margin-bottom: 20px;">
            <form action="customers" method="get">
                ...
                <div class="form-group" style="display: flex; align-items: center; gap: 10px;">
                    <input type="text" id="search" name="search" placeholder="Search by Name or Account No." value="${searchTerm}" style="flex-grow: 1; padding: 10px; border: 1px solid #ddd; border-radius: 4px;">
                    <button type="submit" class="btn btn-primary">Search</button>
                    <a href="customers?action=list" class="btn btn-primary">Clear</a>
                </div>
            </form>
        </div>
